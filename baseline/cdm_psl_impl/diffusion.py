...
import gc
from baseline.cdm_psl_impl.data_enhancement import data_enhancement
...
def gen_offspring(
    ...
    try:
        ...
        for i in range(int(n_guided_samples)):
        ...
        del alphas_prod_p
        del alphas_bar_sqrt
        del one_minus_alphas_bar_log
        del one_minus_alphas_bar_sqrt
        del new_offsprings
        _cleanup_cuda_cache()
